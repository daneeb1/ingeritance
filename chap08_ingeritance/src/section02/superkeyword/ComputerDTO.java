...
public class ComputerDTO extends ProductDTO{
	...
	public ComputerDTO(String cpu, int hdd, int ram, String operationSystem) {
		...
		System.out.println("ComputerDTO 클래스의 모든 필드를 초기화 하는 생성자를 호출");
	}
	
	public ComputerDTO(String code, String brand, String name, Date manufacturingDatem
			, String cpu, int hdd, String operationSystem, int ram) {
...
//		return "ComputerDTO [cpu = " + super.getCode() 
//				+ ", brand = " + super.getBrand()
//				+ ", name = " + super.getName()
//				+ ", menufacturingDate = " + super.getManuFacturingDate()
//				+ cpu + ", hdd = " 
//				+ hdd + ", ram = "
//				+ ram + ", operationSystem = " + operationSystem
//				+ "]";
